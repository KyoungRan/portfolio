      ...
      <div className="projects-shell w-full space-y-8">
        ...
        <div className="w-full overflow-x-auto overflow-y-hidden rounded-[3px] border border-border">
          <table className="w-full min-w-[600px] border-collapse text-left text-[13.5px] leading-relaxed text-[#37352f]">
            <thead className="bg-[#f7f6f3]/80 text-[11px] font-bold tracking-tight text-[#787774] border-b border-[rgba(55,53,47,0.09)]">
              <tr>
                <th
                  className="w-48 border-r border-[rgba(55,53,47,0.09)] font-bold text-center"
                  style={{ padding: '5px 9px' }}
                >
                  기간
                </th>
                <th className="font-bold text-center" style={{ padding: '5px 9px' }}>
                  활동 / 성과
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[rgba(55,53,47,0.09)]">
              {content.rows.map((row) => (
                <tr key={`${row.periodText}-${row.activity}`} className="group hover:bg-[rgba(55,53,47,0.02)] transition-colors">
                  <td
                    className="border-r border-[rgba(55,53,47,0.09)] align-top font-bold text-[#37352f]"
                    style={{ padding: '5px 9px' }}
                  >
                    {row.periodText}
                  </td>
                  <td className="font-bold text-[#37352f]/90 tracking-tight" style={{ padding: '5px 9px' }}>
